...
meas_v = truth[-1][1] + random.gauss(0, 0.03*4000)

def score(Lp, m0, use_v):
    g = run_ppt(Lp, m0)
...
print("SENSOR 1 ONLY (current probe):\n")
surface(False)
print("\nSENSOR 1 + 2 (current + exit velocity):\n")
surface(True)
print("\nrows=Lp  cols=m0  dark=good fit")
print("watch the diagonal valley collapse to a dot.")
