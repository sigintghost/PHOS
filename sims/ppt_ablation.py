...
print("CURRENT ONLY:\n")
surface(False)
print("\nCURRENT + MASS-SHOT (ablation measured):\n")
surface(True)
print("\nrows=Lp  cols=kab(ablation)  dark=good fit")
print("mass-shot is a real independent measurement.")
